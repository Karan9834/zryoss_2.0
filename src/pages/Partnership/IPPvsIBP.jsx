...
export default function IPPvsIBP() {
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <FadeUp>
          <h1 className="text-5xl md:text-6xl font-bold max-w-4xl">
            IPP vs IBP — Which Partnership Is Right for You?
          </h1>
        </FadeUp>
        ...
        <FadeUp delay={0.4}>
          <div className="mt-24 border border-[var(--border)] rounded-xl p-10 bg-gradient-to-r from-[var(--accent)]/10 to-transparent">
            ...
            <p className="mt-6 max-w-4xl text-[var(--text-secondary)]">
              ...
              long-term responsibility and leadership. Choose IBP if you
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              ...
              <Button outline onClick={() => navigate('/partnership/IBP')}>Apply as IBP</Button>
            </div>
          </div>
        </FadeUp>
