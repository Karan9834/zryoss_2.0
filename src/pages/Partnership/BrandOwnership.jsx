                ...
                <div className="p-8 border border-white/10 bg-white/5 rounded-[24px] backdrop-blur-sm inline-block w-full shadow-2xl relative overflow-hidden group">
                  ...
                  <div className="flex items-start gap-4 text-left relative z-10">
                    ...
                    <p className="text-lg text-gray-300 leading-relaxed italic">
                      "Every partner—IPP or IBP—builds and operates their own independent brand. Zryoss does not own partner brands or claim client ownership."
                    </p>
                  </div>
                </div>
              </FadeUp>
      ...
      <section className="py-24 bg-[#050505] relative overflow-hidden text-center">
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            ...
            <Link to="/partnership/IBP" className="px-8 py-4 bg-white/5 text-white font-bold rounded-full border border-white/10 hover:bg-white/10 transition-colors">
              Explore IBP Model
            </Link>
          </div>
        </div>
