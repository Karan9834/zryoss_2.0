                            ...
                            <FadeUp>
                                ...
                                <div className="p-8 border border-white/10 bg-white/5 rounded-[24px] backdrop-blur-sm inline-block w-full shadow-2xl relative overflow-hidden group">
                                    ...
                                    <p className="text-lg text-gray-300 relative z-10 leading-relaxed italic">
                                        "One IBP. Multiple Verticals. <strong className="text-white">One Centralized Operating System.</strong>"
                                    </p>
                                </div>
                            </FadeUp>
                        </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <AnimatedSection>
                            ...
                            <p className="text-neutral-400 text-lg mb-8 leading-relaxed">
                                The Multi-Vertical Business Model under Zryoss allows an Independent Business Partner (IBP) to operate multiple business categories simultaneously—without building separate teams, systems, or execution infrastructure for each vertical.
                            </p>
                ...
                <div className="max-w-5xl mx-auto text-center">
                    <AnimatedSection>
                        ...
                        <p className="text-neutral-400 text-lg mb-12 max-w-3xl mx-auto">
                            At scale, businesses face three problems: separate teams, fragmented execution, and operational overload. Zryoss solves this by allowing IBPs to expand horizontally (across verticals) instead of vertically (through hierarchy).
                        </p>
                        ...
                        <AnimatedSection delay={200}>
                            <div className="bg-white/5 p-8 rounded-2xl h-full border border-white/5 hover:border-orange-500/20 transition-all">
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    <div>
                                        <h4 className="text-white font-bold mb-2 text-sm">The IBP</h4>
            ...
            <section className="py-24 px-6 relative z-10">
                <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12">
                    <AnimatedSection>
                        ...
                        <div className="bg-gradient-to-br from-[#111] to-black border border-white/10 p-8 rounded-3xl h-full">
                            ...
                            <div className="mt-6 pt-6 border-t border-white/10 text-orange-400 text-sm font-medium">
                                IBP does not manage vertical teams separately.
                            </div>
                        </div>
                    </AnimatedSection>
                    ...
                    <AnimatedSection delay={200}>
                        ...
                        <div className="bg-gradient-to-br from-[#111] to-black border border-white/10 p-8 rounded-3xl h-full">
                            <p className="text-neutral-400 mb-6">An IBP may enable multiple IPPs under different verticals to operate under their own brands, while Zryoss handles execution.</p>
