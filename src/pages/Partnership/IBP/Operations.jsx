        ...
        <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-orange-600/30">
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <AnimatedSection>
                            ...
                            <p className="text-neutral-400 text-lg mb-8 leading-relaxed">
                                At multi-vertical scale, the biggest risks are over-promising, uncontrolled execution, and conflicting communication. Zryoss prevents this by centralizing operations and demo authority—even at the IBP level.
                            </p>
                        </AnimatedSection>
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <AnimatedSection>
                            <div className="bg-[#0f0f0f] border border-orange-500/20 p-8 rounded-3xl h-full hover:bg-[#151515] transition-colors relative overflow-hidden group">
                                ...
                                <p className="mt-8 text-sm text-neutral-500 italic border-t border-white/5 pt-4">
                                    Ensures system integrity across all IBP-led verticals.
                                </p>
                            </div>
                        </AnimatedSection>
                        ...
                        <AnimatedSection delay={200}>
                            <div className="bg-[#0f0f0f] border border-blue-500/20 p-8 rounded-3xl h-full hover:bg-[#151515] transition-colors relative overflow-hidden group">
                                ...
                                <p className="mt-8 text-sm text-neutral-500 italic border-t border-white/5 pt-4">
                                    IBP leads business direction, not execution mechanics.
                                </p>
                            </div>
                        </AnimatedSection>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-3 gap-8">
                        ...
                        <AnimatedSection delay={100}>
                            <div className="bg-white/5 p-6 rounded-2xl h-full border border-white/5">
                                ...
                                <h3 className="text-xl font-bold text-white mb-4">IBP's Role in Demos</h3>
                                <div className="space-y-4">
                                    <div>
                                        <p className="text-green-400 text-xs font-bold mb-1 uppercase">IBP May:</p>
                                        <p className="text-neutral-300 text-sm">Participate at business level, introduce solutions, support relationships.</p>
                                    </div>
                                    <div>
                                        <p className="text-red-400 text-xs font-bold mb-1 uppercase">IBP Does Not:</p>
            ...
            <section className="py-24 px-6 relative z-10">
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="space-y-4">
                        {[
                            { step: "01", title: "IBP acquires a client or IPP opportunity" },
            ...
            <section className="py-24 px-6 bg-[#080808] border-y border-white/5">
                <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12">
                    <AnimatedSection>
                        <h3 className="text-2xl font-bold text-white mb-6">IPPs Under an IBP</h3>
                        <div className="bg-[#111] p-8 rounded-2xl border border-white/5 h-full">
                            <p className="text-neutral-400 mb-6">Even for IPPs operating under an IBP:</p>
                            <ul className="space-y-3 mb-6">
                                ...
                                <li className="flex gap-3 text-neutral-300"><ArrowRightCircle className="text-orange-500" size={20} /> IBP does not override authority</li>
                            </ul>
                    ...
                    <AnimatedSection>
                        ...
                        <div className="grid sm:grid-cols-2 gap-4 mb-16 text-left">
                            <div className="p-4 bg-white/5 rounded-xl border border-white/10">
                                <h4 className="font-bold text-white mb-2">For IBPs</h4>
