                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="relative hidden lg:block">
                            <FadeUp delay={0.2}>
                                ...
                                <img
                                    src="/ibp_performance_scale_model.jpg"
            ...
            <section className="py-24 px-6 relative z-10">
                <div className="max-w-7xl mx-auto">
                    <AnimatedSection className="text-center mb-16">
                        <h2 className="text-3xl md:text-5xl font-bold mb-4">How an IBP Scales</h2>
                    ...
                    <AnimatedSection delay={200}>
                        <div className="bg-gradient-to-br from-white/5 to-transparent p-8 rounded-3xl border border-white/10 text-center">
                            ...
                            <p className="text-neutral-400 mb-8">
                                As an IBP grows, execution scales via brands, vendor networks expand, and systems remain unchanged. Growth strengthens the ecosystem, it does not destabilize it.
                            </p>
