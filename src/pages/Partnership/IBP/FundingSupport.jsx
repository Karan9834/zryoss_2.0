...
export default function IBPFundingSupport() {
    ...
    const supportFeatures = [
        ...
        },
        {
            ...
            description: "Applications are routed through your IBP structure and monitored under our compliance framework."
        },
        {
            icon: FileText,
                        ...
                        <div className="flex flex-col justify-center">
                            <FadeUp>
                                ...
                                <p className="text-xl text-gray-400 leading-relaxed font-light mb-8">
                                    Empowering every IBP to build a financially strong network of IPPs with access to India's official startup and MSME funding schemes.
                                </p>
                        ...
                        <div className="relative flex items-center justify-center lg:justify-end">
                            <FadeUp delay={0.2}>
                                ...
                                <div className="relative rounded-3xl overflow-hidden border border-white/10 shadow-2xl shadow-orange-500/20 w-full max-w-2xl">
                                    <img
                                        src="/partnership/ibp_funding_hero.jpg"
                                        alt="IBP leadership team managing funding-ready IPP network"
                                    ...
                                    <div className="absolute bottom-6 left-6 right-6 p-4 bg-black/60 backdrop-blur-xl border border-white/10 rounded-xl">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <div className="text-xs text-neutral-400 uppercase tracking-wider">IBP Leadership</div>
                    ...
                    <div className="max-w-4xl mx-auto text-center mb-12">
                        <AnimatedSection>
                            ...
                            <p className="text-xl text-gray-400 leading-relaxed max-w-3xl mx-auto">
                                As an IBP, you manage multiple business domains and multiple IPPs under your leadership. We ensure your entire ecosystem — including your IPPs — is financially empowered and compliant, so growth never stops due to lack of funding.
                            </p>
                        </AnimatedSection>
                    </div>
                    ...
                    <div className="max-w-4xl mx-auto text-center mb-12">
                        <AnimatedSection>
                            ...
                            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
                                Comprehensive support system for IBPs and their IPP networks
                            </p>
                        </AnimatedSection>
                    </div>
                    ...
                    <div className="text-center mb-20">
                        <AnimatedSection>
                            ...
                            <p className="text-xs uppercase tracking-[0.25em] text-gray-500">
                                HOW WE ENABLE IBP FUNDING ACCESS
                            </p>
                        </AnimatedSection>
                    </div>
                    ...
                    <AnimatedSection delay={600}>
                        <div className="max-w-5xl mx-auto mb-10">
                            <div className="flex items-center justify-center gap-0 flex-wrap">
                                ...
                                {/* IBP Capsule */}
                                <div className="group px-6 py-3 rounded-full bg-white/[0.03] backdrop-blur-sm border border-orange-500/20 hover:bg-white/[0.06] hover:border-orange-500/40 hover:-translate-y-1 transition-all duration-300 shadow-lg">
                                    <span className="text-sm font-bold text-white">IBP</span>
                                </div>
                    ...
                    <AnimatedSection delay={700}>
                        <div className="text-center max-w-2xl mx-auto p-5 rounded-2xl bg-orange-500/5 border border-orange-500/20">
                            <p className="text-gray-300 font-medium">
                                💡 Every IBP's IPP network stays fully funding-ready.
                            </p>
                        </div>
                    </AnimatedSection>
                </div>
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                    <AnimatedSection>
                        ...
                        <p className="text-xl text-gray-400 mb-12 max-w-3xl mx-auto leading-relaxed">
                            Join us as an IBP and help your IPPs access India's official government startup and MSME funding programs through structured, compliant guidance.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            ...
                            <button
                                onClick={() => navigate("/partnership/IBP")}
