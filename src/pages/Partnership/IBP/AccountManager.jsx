                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <AnimatedSection>
                            <h2 className="text-3xl md:text-5xl font-bold mb-8 leading-tight">
                                Why IBPs <span className="text-orange-500">Need a DAM</span>
                            </h2>
                            <p className="text-neutral-400 text-lg mb-8 leading-relaxed">
                                IBPs operate at a multi-vertical, multi-IPP, and high-volume level. Without a dedicated layer, this leads to fragmented communication and loss of control.
                            </p>
                            <div className="p-6 bg-orange-500/10 border-l-4 border-orange-500 rounded-r-lg">
                                <p className="text-lg text-white font-medium">
                                    Zryoss assigns one accountable owner for the entire IBP engagement.
                                </p>
                            </div>
                        </AnimatedSection>
                    ...
                    <AnimatedSection>
                        ...
                        <div className="grid md:grid-cols-2 gap-6 text-left">
                            <div className="p-8 bg-gradient-to-br from-[#111] to-black border border-white/10 rounded-3xl h-full">
                                ...
                                <ul className="space-y-4">
                                    {[
                                        ...
                                        "Alignment between IBP strategy and execution",
                            ...
                            <div className="p-8 bg-gradient-to-br from-[#111] to-black border border-white/10 rounded-3xl h-full">
                                ...
                                <ul className="space-y-4">
                                    {[
                                        "Replace the IBP’s leadership role",
                        ...
                        {[
                            {
                                ...
                                icon: UserCheck,
                                desc: "The primary backend contact for IBP, coordinating all execution brands and managing internal alignment.",
                                note: "IBP never needs to chase multiple teams."
                            },
                            {
                                num: "02",
                            ...
                            },
                            {
                                ...
                                note: "Protects both IBP leadership and ecosystem integrity."
                            },
                            {
                                num: "04",
                    ...
                    <AnimatedSection>
                        ...
                        <div className="bg-[#111] p-8 rounded-2xl border border-white/5 h-full">
                            <ul className="space-y-6">
                                {[
                                    { t: "Account capacity scales internally", d: "More resources added as IBP grows." },
