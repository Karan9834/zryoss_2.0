                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="relative hidden lg:block">
                            <FadeUp delay={0.2}>
                                ...
                                <img
                                    src="/IBP Creation.png"
                                    alt="IBP → IPP Creation & Management"
                        ...
                        <AnimatedSection>
                            ...
                            <div className="p-6 bg-orange-500/10 border-l-4 border-orange-500 rounded-r-lg">
                                <p className="text-lg text-white font-medium">
                                    IBPs act as business enablers, not controllers.
                                </p>
                            </div>
                        </AnimatedSection>
            ...
            <section className="py-24 px-6 bg-[#0a0a0a] border-y border-white/5">
                <div className="max-w-7xl mx-auto">
                    <AnimatedSection className="mb-16 text-center">
                        <h2 className="text-3xl md:text-5xl font-bold mb-4">Role of the IBP</h2>
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <AnimatedSection>
                            <div className="p-8 bg-white/5 rounded-2xl border border-white/5 h-full">
                                <h3 className="text-xl font-bold text-blue-400 mb-6 flex items-center gap-2"><CheckCircle2 /> An IBP May</h3>
                        ...
                        <AnimatedSection delay={100}>
                            <div className="p-8 bg-white/5 rounded-2xl border border-white/5 h-full">
                                <h3 className="text-xl font-bold text-orange-500 mb-6 flex items-center gap-2"><XCircle /> An IBP Does NOT</h3>
                                <ul className="space-y-3 text-neutral-300">
            ...
            <section className="py-24 px-6 relative z-10">
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="relative border-l border-white/10 ml-6 md:ml-12 pl-8 md:pl-12 space-y-12">
                        {[
                            { title: "IBP identifies a potential IPP", desc: "Initial scouting and fitment check." },
                ...
                <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12">
                    <AnimatedSection>
                        ...
                        <div className="bg-[#111] p-8 rounded-2xl border border-white/5">
                            <p className="text-neutral-400 mb-6">Every IPP enabled under an IBP:</p>
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="space-y-6">
                            <h3 className="text-xl font-bold text-white border-l-4 border-green-500 pl-4">An IBP May</h3>
                            <ul className="space-y-4">
                        ...
                        <div className="space-y-6">
                            <h3 className="text-xl font-bold text-white border-l-4 border-red-500 pl-4">An IBP Does Not</h3>
                            <ul className="space-y-4">
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <AnimatedSection>
                        ...
                        <div className="grid sm:grid-cols-2 gap-4 text-left">
                            <div className="p-4 rounded-lg bg-white/5 text-neutral-300 border border-white/5">✅ IBP is functionally stable</div>
