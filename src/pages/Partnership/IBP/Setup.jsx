...
export default function BrandAndBusinessSetup() {
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-orange-600/30">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative hidden lg:block">
              <FadeUp delay={0.2}>
                ...
                <img
                  src="/brand_business_setup_by_zryoss.png"
      ...
      {/* IBP vs IPP Description */}
      <section className="py-24 px-6 relative z-10 bg-neutral-900/30 border-y border-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <AnimatedSection>
              <h2 className="text-3xl md:text-5xl font-bold mb-8 leading-tight">
                What Makes an IBP <br />
                <span className="text-orange-500">Different?</span>
              </h2>
              <p className="text-neutral-400 text-lg mb-8 leading-relaxed">
                While an IPP focuses on one primary business vertical, an IBP operates at a multi-vertical, expansion-oriented level. IBP works on the system, not just in the system.
              </p>
      ...
      <section className="py-24 px-6 relative z-10">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12">
          <AnimatedSection>
            <h3 className="text-3xl font-bold text-white mb-8">Core Role of an IBP</h3>
            <div className="bg-[#111] p-8 rounded-3xl border border-white/10 h-full">
              ...
              <div className="mt-8 pt-8 border-t border-white/10 text-neutral-400 text-sm">
                <strong className="text-white">Zryoss manages execution.</strong> IBP manages business expansion and leadership.
              </div>
            </div>
          </AnimatedSection>

          <AnimatedSection delay={200}>
            <h3 className="text-3xl font-bold text-white mb-8">Who Is an IBP Ideal For?</h3>
            <div className="bg-[#111] p-8 rounded-3xl border border-white/10 h-full">
              <ul className="space-y-6">
                {[
      ...
      <section className="py-24 px-6 relative z-10">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12">
          ...
          <AnimatedSection delay={200}>
            <div className="p-8 border border-white/10 rounded-3xl bg-neutral-900/50">
              <h3 className="text-2xl font-bold text-white mb-6">IBP & IPP Relationship</h3>
              <ul className="space-y-3 text-neutral-300 mb-6">
                ...
                <li className="flex gap-2"><CheckCircle2 size={18} className="text-blue-500" /> IBP provides leadership</li>
              </ul>
      ...
      <section className="py-24 px-6 bg-gradient-to-b from-[#111] to-black border-y border-white/5">
        <div className="max-w-4xl mx-auto text-center">
          <AnimatedSection>
            <h2 className="text-3xl md:text-5xl font-bold mb-8">IBP Commercial Model</h2>
        ...
        <div className="max-w-4xl mx-auto">
          <AnimatedSection>
            <div className="bg-red-900/10 border border-red-500/20 rounded-2xl p-8 text-center">
              ...
              <p className="mt-8 text-neutral-400">IBP is a business operating partnership focused on execution and scale.</p>
            </div>
          </AnimatedSection>
        </div>
      </section>
      ...
      <section className="py-24 px-6 bg-[#080808]">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12">
          <AnimatedSection>
            <h3 className="text-2xl font-bold text-white mb-6">Why The IBP Model Works</h3>
            ...
            <p className="mt-6 text-sm text-neutral-500 italic">IBPs build business networks, not sales chains.</p>
          </AnimatedSection>
          ...
          <AnimatedSection delay={200}>
            <div className="bg-[#111] p-8 rounded-2xl border border-white/5">
              ...
              <div className="space-y-4 mb-6">
                <h4 className="text-green-500 font-bold text-sm uppercase">An IBP Owns</h4>
            ...
            <div className="inline-block p-1 rounded-full bg-gradient-to-r from-orange-500 to-amber-500 p-1">
              <div className="px-12 py-6 bg-black rounded-full">
                <h3 className="text-2xl font-bold text-white">
                  Zryoss provides the structure. IBP builds the scale.
                </h3>
              </div>
            </div>
          </AnimatedSection>
