  ...
  const testimonials = [
    {
      ...
      content: "Transitioning to the Zryoss IBP model was the best career move I've made. I focus on high-level networking, and their technical team delivers beyond expectations. My commissions have tripled in 6 months.",
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <AnimatedSection delay={200}>
              ...
              <div className="space-y-6 text-lg text-neutral-400 font-light">
                <p>
                  The Zryoss Independent Business Partner (IBP) program is built for visionaries who want to earn based on their network, not their headcount.
                </p>
                <p>
        ...
        <div className="max-w-6xl mx-auto w-full relative">
          <AnimatedSection className="text-center mb-20">
            ...
            <p className="text-neutral-400 text-lg max-w-2xl mx-auto">
              Don't just take our word for it. Hear from the professionals who are scaling their income with the Zryoss IBP model.
            </p>
          </AnimatedSection>
            ...
            {[
              {
                ...
                answer: "Absolutely not. The IBP program is a direct sales commission model. You earn only from the deals you facilitate. There are no downlines, no recruitment requirements, and no pyramid structures."
              },
              {
            ...
            <div className="lg:col-span-2 bg-orange-600 p-12 text-white flex flex-col justify-between relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-orange-100 mb-12">
                  Join the Zryoss IBP program today and transform your professional network into a revenue stream.
                </p>
