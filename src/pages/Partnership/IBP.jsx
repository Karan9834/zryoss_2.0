...
export default function IBPPage() {
  ...
  const testimonials = [
    {
      ...
      content: "Transitioning to the Zryoss IBP model was the best career move I've made. I focus on high-level networking, and their technical team delivers beyond expectations. My success has tripled in 6 months.",
      avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=200",
      stats: "High Growth Achieved"
    },
    {
      name: "Sarah Jenkins",
  ...
  const workflowSteps = [
    ...
    },
    {
      ...
      desc: "Direct performance recognition.",
      icon: Wallet,
          ...
          <AnimatedSection>
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full mb-8 hover:bg-white/10 transition-colors cursor-default">
                ...
                <span className="text-xs font-semibold tracking-wide uppercase text-neutral-300">Official Independent Business Partner Program 2025</span>
              </div>
              ...
              <p className="text-xl md:text-2xl text-neutral-400 mb-10 leading-relaxed max-w-2xl mx-auto font-light">
                High-ticket business growth with zero recruitment. Scale your professional impact by connecting enterprises with world-class solutions.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="relative rounded-2xl overflow-hidden aspect-[4/5] lg:aspect-square group shadow-2xl">
                ...
                <div className="absolute bottom-8 left-8 right-8">
                  <div className="p-4 bg-white/10 backdrop-blur-md border border-white/20 rounded-xl">
                    <div className="text-3xl font-bold text-white mb-1">Significant</div>
                    <div className="text-sm text-neutral-300">Value Generated by Partners</div>
                  </div>
                </div>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection delay={200}>
              ...
              <div className="space-y-6 text-lg text-neutral-400 font-light">
                <p>
                  The Zryoss Independent Business Partner (IBP) program is built for visionaries who want to grow based on their network, not their headcount.
                </p>
                <p>
                  We act as your delivery engine. You own the relationship and the introduction. We provide the heavy lifting—implementation, consulting, and support—while you achieve significant results on every deal.
                </p>
                <div className="pt-6">
                  <div className="flex items-center gap-4 text-white font-medium">
                    ...
                    <span>No joining commercials. No recruitment targets.</span>
                  </div>
                </div>
              </div>
            </AnimatedSection>
          ...
          <AnimatedSection className="mb-20">
            <div className="flex flex-col md:flex-row justify-between items-end gap-8 pb-8 border-b border-white/5">
              <div className="max-w-2xl">
                <h2 className="text-4xl md:text-5xl font-bold mb-4">Why Become an IBP?</h2>
                <p className="text-neutral-400 text-lg">Unlock specific advantages designed to accelerate your professional growth with clear data-driven benefits.</p>
              </div>
              <button
                onClick={() => navigate('/apply')}
            ...
            {[
              {
                ...
                desc: "Direct results on deal value. High-ticket services mean high-ticket impact.",
                metrics: [
                  { label: "Success Cap", value: "Unlimited" },
              ...
              },
              {
                ...
                metrics: [
                  { label: "Investment", value: "Minimal" },
      ...
      <section className="min-h-screen flex flex-col justify-center py-20 px-6 relative z-10 bg-[#050505] overflow-hidden">
        <div className="max-w-7xl mx-auto w-full relative">
          <AnimatedSection className="text-center mb-24">
            ...
            <p className="text-neutral-400 text-lg">Four distinct phases to your next successful milestone.</p>
          </AnimatedSection>
        ...
        <div className="max-w-6xl mx-auto w-full relative">
          <AnimatedSection className="text-center mb-20">
            ...
            <p className="text-neutral-400 text-lg max-w-2xl mx-auto">
              Don't just take our word for it. Hear from the professionals who are scaling their impact with the Zryoss IBP model.
            </p>
          </AnimatedSection>
            ...
            {[
              {
                ...
                answer: "Absolutely not. The IBP program is a direct sales model. Success is driven by the deals you facilitate. There are no downlines, no recruitment requirements, and no pyramid structures."
              },
              {
              ...
              },
              {
                ...
                answer: "The onboarding process is simple and straightforward. You sign the partner agreement and get immediate access to our sales collateral and partner dashboard."
              }
            ].map((faq, i) => (
              <AnimatedSection key={i} delay={i * 50}>
                <FAQItem
            ...
            <div className="lg:col-span-2 bg-orange-600 p-12 text-white flex flex-col justify-between relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-orange-100 mb-12">
                  Join the Zryoss IBP program today and transform your professional network into a growth stream.
                </p>
      ...
      <footer className="bg-black py-16 px-6 border-t border-neutral-900">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="text-neutral-600 text-xs">
            © 2025 Zryoss Independent Business Partner. All rights reserved.
          </div>
        </div>
      </footer> */}
