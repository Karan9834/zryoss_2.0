    ...
    return (
        <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-orange-600/30">
            ...
            <div className="fixed inset-0 pointer-events-none z-0">
                <div className="absolute top-[-20%] left-[-10%] w-[800px] h-[800px] bg-orange-600/5 rounded-full blur-[120px]" />
                <div className="absolute bottom-[-10%] right-[-10%] w-[600px] h-[600px] bg-indigo-600/5 rounded-full blur-[100px]" />
            </div>
                ...
                <div className="max-w-7xl mx-auto relative z-10 w-full text-center">
                    <AnimatedSection>
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full mb-8 hover:bg-white/10 transition-colors cursor-default">
                            ...
                            <span className="text-xs font-semibold tracking-wide uppercase text-neutral-300">Controlled Expansion</span>
                        </div>
                        ...
                        <div className="inline-block bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-sm max-w-2xl">
                            <p className="text-neutral-300 text-lg">
                                Designed for business scale, not recruitment-based income. <br />
                                Expand reach while keeping execution, governance, and control centralized.
                            </p>
                        </div>
                    </AnimatedSection>
                </div>
