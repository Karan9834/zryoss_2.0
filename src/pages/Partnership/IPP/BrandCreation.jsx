                ...
                <div className="max-w-7xl mx-auto relative z-10 w-full text-center">
                    <AnimatedSection>
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full mb-8 hover:bg-white/10 transition-colors cursor-default">
                            ...
                            <span className="text-xs font-semibold tracking-wide uppercase text-neutral-300">IPP Journey Phase 1</span>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                            <div className="px-8 py-4 bg-white/5 border border-white/10 rounded-2xl flex items-center gap-4 text-left">
                                ...
                                <div>
                                    <div className="text-sm text-neutral-400">Ownership</div>
                                    <div className="font-bold text-white">You own the brand</div>
                                </div>
                            </div>
                            <div className="px-8 py-4 bg-white/5 border border-white/10 rounded-2xl flex items-center gap-4 text-left">
                                ...
                                <div>
                                    <div className="text-sm text-neutral-400">Foundation</div>
                                    <div className="font-bold text-white">Zryoss builds it</div>
                                </div>
                            </div>
                        </div>
                    </AnimatedSection>
