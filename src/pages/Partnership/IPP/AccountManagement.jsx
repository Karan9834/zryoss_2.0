                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                            ...
                            <FadeUp>
                                ...
                                <div className="p-8 border border-white/10 bg-white/5 rounded-[24px] backdrop-blur-sm inline-block w-full shadow-2xl relative overflow-hidden group">
                                    ...
                                    <p className="text-lg text-gray-300 relative z-10 leading-relaxed italic">
                                        "IPP does not manage the backend. IPP does not chase execution. <strong className="text-white">IPP operates through a dedicated structure.</strong>"
                                    </p>
                                </div>
                            </FadeUp>
                        </div>
                        ...
                        <div className="relative hidden lg:block">
                            <FadeUp delay={0.2}>
                                ...
                                <img
                                    src="/IPP Account Management.png"
                                    alt="IPP Account Management"
