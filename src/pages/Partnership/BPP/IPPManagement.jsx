                ...
                <div className="max-w-7xl mx-auto relative z-10 w-full text-center">
                    <AnimatedSection>
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full mb-8 hover:bg-white/10 transition-colors cursor-default">
                            ...
                            <span className="text-xs font-semibold tracking-wide uppercase text-neutral-300">Structured Business Expansion</span>
                        </div>

                        <h1 className="text-4xl md:text-6xl lg:text-8xl font-bold mb-8 leading-[0.95] tracking-tight">
                            BPP → IPP <br />
