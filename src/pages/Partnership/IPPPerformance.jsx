...
export default function IPPPerformance() {
        ...
        <FadeUp delay={0.25}>
          <div className="mt-24 border border-[var(--border)] rounded-xl p-8 bg-[var(--bg-card)]">
            <h3 className="text-2xl font-semibold text-[var(--accent)]">
              Where IPP Performance Comes From
            </h3>

            <p className="mt-6 text-[var(--text-secondary)] max-w-4xl">
              IPP success is generated when an IPP successfully closes a
            ...
            <p className="mt-4 text-[var(--text-secondary)] max-w-4xl">
              Growth is tied to actual service execution, client satisfaction,
        ...
        <FadeUp delay={0.4}>
          <div className="mt-24 border border-[var(--border)] rounded-xl p-10 bg-gradient-to-r from-[var(--accent)]/10 to-transparent">
            ...
            <p className="mt-6 max-w-4xl text-[var(--text-secondary)]">
              Zryoss does not offer any form of assured success, results,
              rewards on recruitment, or investment-linked growth.
              All success is performance-based and tied strictly to real
              business outcomes.
            </p>
