          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold text-white mb-2">Independent Business Partner (IBP)</h3>
      ...
      <section className="py-24 px-6 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-6 gap-6">
            {[
              { step: 1, title: "Select Model", desc: "Appropriate model (IPP or IBP)" },
          ...
          <p className="text-center mt-12 text-orange-400 text-lg font-medium opacity-80">Growth happens through execution, not recruitment.</p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-white/70 text-lg max-w-xl mb-10">
                Start lean with IPP or scale aggressively with IBP.
            ...
            <div className="relative">
              <div className="grid gap-6">
                ...
                {/* Card 2 */}
                <div className="p-6 rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10 hover:border-orange-500/40 transition-all">
                  <h3 className="text-xl font-semibold text-white mb-2">IBP Model</h3>
                  <p className="text-white/60 text-sm">
