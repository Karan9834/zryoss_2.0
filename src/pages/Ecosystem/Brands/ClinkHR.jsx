            ...
            <FadeUp>
              ...
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-orange-500/30 bg-orange-500/10 backdrop-blur-sm mb-6">
                ...
                <span className="text-xs uppercase tracking-[0.45em] text-orange-500 font-bold">
                  Recruitment & HR Execution
                </span>
              </div>

              {/* H1 */}
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-[1.15] tracking-tight mb-6">
                Clink<span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-500"> HR</span>
              </h1>

              {/* Paragraph */}
              <p className="text-xl text-gray-400 leading-relaxed font-light mb-10">
                Clink HR is the dedicated execution engine responsible for managing and delivering all hiring, recruitment, and HR-related services brought into the ecosystem by IPPs and IBPs.
              </p>
              ...
              <div className="flex flex-wrap gap-4 mb-6">
                <button
                  ...
                  className="rounded-xl bg-gradient-to-r from-orange-500 to-orange-600 px-6 py-3 font-semibold text-white shadow-lg shadow-orange-500/30 hover:shadow-orange-500/60 transition"
                >
                  Partner with Zryoss
                </button>
                <a
              ...
              <p className="mt-6 text-xs text-white/40 tracking-wide font-light">
                Hiring Active: 100+ Roles • Candidates Placed: 5000+
              </p>
            </FadeUp>
            ...
            <div className="md:w-1/2">
              ...
              <div className="grid grid-cols-1 gap-4">
                {[
                  ...
                  "IPPs and IBPs never manage recruitment chaos"
                ].map((item, i) => (
                  <div key={i} className="flex items-center gap-3 p-3 bg-white/5 rounded-xl border border-white/5">
                    <ShieldCheck className="text-orange-500 w-5 h-5 shrink-0" />
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-7 gap-4 relative z-10">
              {[
                { step: "1", title: "Client", desc: "IPP/IBP acquires client" },
          ...
          <div className="mt-12 text-center">
            <p className="text-gray-400 text-sm">IPP or IBP never directly manages recruiters or vendors.</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <div className="bg-[#0a0a0a] p-8 rounded-3xl border border-white/10 mb-8 h-full">
              ...
              <p className="mt-6 text-sm text-orange-400 font-medium">Ensures controlled hiring outcomes.</p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="border-l-4 border-orange-500 pl-8">
              ...
              <div className="space-y-6">
                ...
                <div className="group hover:bg-white/5 p-4 rounded-xl transition-colors">
                  <h4 className="text-orange-500 font-bold text-sm uppercase tracking-wide mb-1">Clink HR</h4>
          ...
          <div className="p-8 rounded-3xl bg-gradient-to-r from-gray-900 to-black border border-white/10 shadow-2xl">
            ...
            <div className="flex flex-col md:flex-row justify-center gap-8 mt-8 text-left md:text-center">
              ...
              <div>
                ...
                <span className="text-xl font-bold text-orange-500">Delivers Talent</span>
              </div>
            </div>
          </div>
        </div>
