            ...
            <div className="md:w-1/2">
              ...
              <div className="grid grid-cols-1 gap-4">
                {[
                  ...
                  "IPPs and IBPs never manage medical tech execution directly"
                ].map((item, i) => (
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-7 gap-4 relative z-10">
              {[
                { step: "1", title: "Acquisition", desc: "IPP/IBP acquires client" },
          ...
          <div className="mt-12 text-center p-4 bg-orange-900/10 border border-orange-500/20 rounded-xl inline-block w-full max-w-2xl mx-auto">
            <p className="text-orange-300 font-medium">IPP or IBP never manages developers, hosting, or deployments.</p>
          </div>
        </div>
      </section>
