                        ...
                        <div className="md:w-1/2">
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                {[
                                    ...
                                    "IPPs and IBPs never manage contractors directly"
                                ].map((item, i) => (
                ...
                <div className="max-w-7xl mx-auto px-6 w-full">
                    ...
                    <div className="relative w-full">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-7 gap-4 relative z-10 w-full">
                            {[
                                { step: "1", title: "Acquisition", desc: "IPP/IBP gets client" },
                    ...
                    <div className="mt-12 text-center">
                        <p className="text-gray-400 text-sm">IPP or IBP never directly manages contractors or vendors.</p>
                    </div>
                </div>
            </section>
