        ...
        <div className="min-h-screen bg-[#050505] text-white selection:bg-orange-500/30 font-sans">
            ...
            <section className="relative pt-32 pb-20 overflow-hidden">
                ...
                <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
                    ...
                    <div className="absolute inset-0 bg-[url('kryoss_interiors_hero.png')] bg-cover bg-center opacity-20 mix-blend-overlay"></div>
                </div>
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        <div className="lg:w-1/2">
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-orange-500/30 bg-orange-500/10 text-orange-400 text-sm font-medium mb-6">
                                <HardHat size={14} />
                                Interior & Real Estate Execution Brand
                            </div>
                            ...
                            <h2 className="text-2xl text-white/80 font-medium mb-6">
                                Interior Design, Fit-out & Real Estate Execution
                            </h2>
                            ...
                            <div className="p-6 border border-white/10 bg-white/5 rounded-2xl backdrop-blur-sm inline-block w-full max-w-lg">
                                <div className="flex items-center gap-4">
                                    ...
                                    <p className="text-lg text-gray-200 italic">
                                        "Whenever an IPP or BPP operates in the interior design or real estate services vertical, <span className="text-white font-bold">execution is managed and delivered through Kryoss Interiors</span>."
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="lg:w-1/2 relative w-full">
                            <div className="relative rounded-3xl overflow-hidden border border-white/10 shadow-2xl group w-full">
                                ...
                                {/* Hero Image Placeholder - utilizing the generated image as main visual too if desired or another relevant Unsplash image */}
                                <img
                                ...
                                <div className="absolute bottom-8 left-8 right-8 z-20">
                                    <div className="flex items-center justify-between">
                                        <div className="flex gap-2">
                                            ...
                                            <span className="text-xs font-mono text-orange-500">EXECUTION EXCELLENCE</span>
                                        </div>
                                        <Building2 className="text-white/50" />
                                    </div>
                                </div>
                            </div>
