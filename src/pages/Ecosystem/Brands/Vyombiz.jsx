          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <FadeUp>
              ...
              <p className="text-xl text-gray-400 leading-relaxed font-light mb-10">
                Vyombiz is responsible for executing business-focused, advisory, consulting, and professional service engagements brought into the ecosystem by IPPs and IBPs.
              </p>
              ...
              <div className="flex flex-wrap gap-4 mb-6">
                <button
                  ...
                  className="rounded-xl bg-gradient-to-r from-orange-500 to-red-600 px-6 py-3 font-semibold text-white shadow-lg shadow-orange-500/30 hover:shadow-orange-500/60 transition"
                >
                  Partner with Zryoss
                </button>
                <a
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-6 gap-6 relative z-10">
              {[
                { step: "1", title: "Closing", desc: "IPP/IBP closes client deal" },
          ...
          <div className="mt-12 text-center p-4 bg-orange-900/10 border border-orange-500/20 rounded-xl inline-block w-full max-w-2xl mx-auto">
            <p className="text-orange-300 font-medium text-sm">IPP or IBP never manages consultants or experts directly.</p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="border-l-4 border-orange-500 pl-8">
              ...
              <div className="space-y-6">
                <div>
                  <h4 className="text-orange-500 font-bold text-sm uppercase tracking-wide mb-1">IPP / IBP</h4>
