                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        ...
                        <FadeUp>
                            ...
                            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-[1.15] tracking-tight mb-6">
                                Ad<span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-600">kryoss</span>
                            </h1>

                            {/* Paragraph */}
                            <p className="text-xl text-gray-400 leading-relaxed font-light mb-10">
                                Adkryoss is the dedicated execution engine responsible for executing all digital marketing, branding, and online growth services brought into the ecosystem by IPPs and IBPs.
                            </p>
                            ...
                            <p className="mt-6 text-xs text-white/40 tracking-wide font-light">
                                Campaigns Active: 500+ • Brands Managed: 200+
                            </p>
                        </FadeUp>
                        ...
                        <FadeUp delay={0.2}>
                            <div className="relative">
                                ...
                                <div className="rounded-3xl border border-white/10 bg-white/5 p-2">
                                    <img
                                        src="/adkryoss.jpg"
                                        alt="Adkryoss Digital Marketing"
                        ...
                        <div className="md:w-1/2">
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                {[
                                    ...
                                    "IPPs and IBPs never manage agencies directly"
                                ].map((item, i) => (
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="relative">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-7 gap-4 relative z-10">
                            {[
                                { step: "1", title: "Client", desc: "IPP/IBP closes client" },
                    ...
                    <div className="mt-12 text-center">
                        <p className="text-gray-400 text-sm">IPP or IBP never coordinates agencies or freelancers directly.</p>
                    </div>
                </div>
            </section>
