          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <FadeUp>
              ...
              <p className="text-xl text-gray-400 leading-relaxed font-light mb-10">
                Kryoss Softech is the dedicated execution engine responsible for delivering all technology-driven services brought by IPPs and IBPs, ensuring specialized focus and quality control.
              </p>
          ...
          <div className="flex flex-col md:flex-row gap-16 items-center">
            <div className="md:w-1/2">
              ...
              <p className="text-lg text-gray-400 mb-8 leading-relaxed">
                Kryoss Softech functions as the dedicated execution engine for all technology and digital solutions within the ZRYOSS platform. Whenever an IPP or IBP operates in a technology vertical, their client work is routed here.
              </p>
              ...
              <p className="mt-8 text-sm text-gray-500 flex items-center gap-2">
                ...
                IPP or IBP never manages developers or vendors directly.
              </p>
            </div>
            <div className="md:w-1/2">
              <div className="grid grid-cols-2 gap-4">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-6 gap-6 relative z-10">
              {[
                { step: "1", title: "Opportunity", desc: "IPP/IBP closes client deal" },
          ...
          <div>
            ...
            <div className="bg-[#0a0a0a] p-8 rounded-3xl border border-white/10 mb-8">
              ...
              <p className="text-sm text-gray-500 border-t border-white/5 pt-4">
                All vendors work under Kryoss Softech’s supervision, not directly with IPPs or IBPs. Ensuring no vendor chaos.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="border-l-4 border-orange-500 pl-8">
              ...
              <div className="space-y-6">
                <div>
                  <h4 className="text-orange-500 font-bold text-sm uppercase tracking-wide mb-1">Partners (IPP/IBP)</h4>
            ...
            <div className="border-l-4 border-orange-500 pl-8">
              ...
              <p className="italic text-gray-500">"As IPPs and IBPs scale, Kryoss Softech scales with them."</p>
            </div>
          </div>
        </div>
      </section>
