    ...
    <div className="min-h-screen bg-[#121212] text-white">
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-2 px-7 py-3 rounded-xl bg-[#FF6A00] text-white font-semibold hover:brightness-110 transition shadow-[0_0_28px_rgba(249,115,22,0.25)]"
                  >
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {risks.map((r, i) => (
              <FadeUp key={r} delay={0.2 + i * 0.05}>
                <div className="p-5 rounded-2xl bg-[#1A1A1A] border border-white/10 hover:border-[#FF6A00]/40 transition h-full">
            ...
            <div className="mt-10 grid sm:grid-cols-2 gap-4 text-left">
              {qaMeans.map((x, i) => (
                <FadeUp key={x} delay={i * 0.05}>
                  <div className="flex items-start gap-3 p-5 rounded-2xl bg-black/15 border border-white/10 h-full">
      ...
      <section id="qa-model" className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="mt-12 grid md:grid-cols-2 lg:grid-cols-4 gap-4">
          {layers.map((l, idx) => (
            <FadeUp key={l.id} delay={idx * 0.05}>
              <button
                onClick={() => {
                ...
                className={`text-left p-5 rounded-2xl border transition h-full w-full ${openLayer === l.id
        ...
        <div className="mt-12 grid lg:grid-cols-4 gap-4">
          {[
            ...
            <FadeUp key={s.title} delay={idx * 0.05}>
              <div className="relative p-6 rounded-2xl bg-[#1E1E1E] border border-white/10 hover:border-[#FF6A00]/40 transition h-full">
                <div className="w-12 h-12 rounded-2xl bg-[#FF6A00]/15 border border-[#FF6A00]/30 text-[#FF6A00] flex items-center justify-center">
                  {s.icon}
                </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            { title: "IPP & IBP", text: "protected brand credibility", icon: <Shield className="w-6 h-6" /> },
