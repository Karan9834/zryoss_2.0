    ...
    const faqs = [
        {
            ...
            answer: "All execution and delivery are centrally managed by Zryoss through its operations framework. IPP or IBP do not manage teams, coordinate vendors, or handle delivery execution. Zryoss owns execution discipline and delivery outcomes.",
        },
        {
            question: "Do IPP or IBP need to manage vendors?",
        ...
        {
            question: "Who is the point of contact for IPP, IBP, or clients?",
        ...
        },
        {
            ...
            answer: "IPP and IBP receive visibility into execution status, delivery progress, issues and resolutions, and account performance. Visibility is provided without operational burden.",
        },
        {
                        ...
                        <div>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <button
                                    ...
                                    className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-[#FF6A00] text-white font-bold hover:bg-[#FF6A00]/90 transition shadow-[0_0_20px_rgba(255,106,0,0.3)]"
                                >
