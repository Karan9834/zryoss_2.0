...
export default function Reporting() {
  ...
  const categories = useMemo(
    () => [
      ...
      },
      {
        id: "cat-5",
        number: "5️⃣",
        title: "Partner Performance Visibility (IPP / IBP)",
  ...
  const stakeholders = [
    ...
    { title: "IPP & IBP", icon: <Handshake className="w-6 h-6" />, text: "business visibility" },
    ...
    <div className="min-h-screen bg-[#121212] text-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <FadeUp delay={0.2}>
              <div className="relative mt-10 lg:mt-0">
                ...
                <img
                  src="/operations_hero_images/reporting_performance.jpg"
                  alt="Reporting Performance"
        ...
        <div className="max-w-7xl mx-auto px-6 py-20">
          ...
          <div className="relative mt-12">
            ...
            <div className="relative grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {reportingMeans.map((x, i) => (
                <FadeUp key={x.text} delay={i * 0.05}>
                  <div
                    className="p-6 rounded-2xl bg-black/15 border border-white/10 hover:border-[#FF6A00]/40 transition h-full"
                  >
      ...
      < section id="reporting-system" className="max-w-7xl mx-auto px-6 py-20" >
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <FadeUp delay={0.2}>
            <div className="relative">
              <div className="absolute inset-0 rounded-3xl bg-[#FF6A00]/10 blur-2xl" />
              <div className="relative rounded-3xl border border-white/10 bg-[#121212] p-8 overflow-hidden h-full">
      ...
      < section className="max-w-7xl mx-auto px-6 py-20" >
        ...
        <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {kpis.map((k, i) => (
            <FadeUp key={k.title} delay={i * 0.05}>
              <div
                className="p-6 rounded-2xl bg-[#1E1E1E] border border-white/10 hover:border-[#FF6A00]/40 transition relative overflow-hidden h-full"
              >
            ...
            <FadeUp>
              <div className="space-y-3">
                {governance.map((p, i) => (
                  <FadeUp key={p} delay={i * 0.05}>
                    <div
                      className="flex items-start gap-4 p-4 rounded-xl bg-black/15 border border-white/10"
                    >
                      <ShieldCheck className="w-5 h-5 text-[#FF6A00] mt-1" />
                      <span className="text-gray-200">{p}</span>
                    </div>
                  </FadeUp>
                ))}
              ...
              <div className="relative rounded-3xl border border-white/10 bg-[#121212] overflow-hidden p-8">
                ...
                <div className="relative grid grid-cols-2 gap-4">
                  {[
                    ...
                    <FadeUp key={x.label} delay={i * 0.05}>
                      <div
                        className="p-4 rounded-2xl bg-black/20 border border-white/10 h-full"
                      >
