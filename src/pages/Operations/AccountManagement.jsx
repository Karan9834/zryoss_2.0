...
export default function AccountManagement() {
  ...
  const whoBenefits = [
    ...
    { title: "IPP & IBP", text: "operational peace of mind", icon: <Shield className="w-6 h-6" /> },
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <FadeUp>
            <div>
              ...
              <p className="mt-4 text-gray-300">
                Every IPP, IBP, and client engagement receives:
              </p>
          ...
          <FadeUp>
            <div>
              <h2 className="text-3xl font-bold">
                ...
                <span className="text-[#FF6A00]">IPP & IBP</span>
              </h2>
