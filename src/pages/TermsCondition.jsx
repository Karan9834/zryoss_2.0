...
const TermsCondition = () => {
    ...
    const sections = [
        ...
        },
        {
            ...
            content: [
                {
                    text: "Use of Zryoss does not create: Employment, Agency, Partnership, Franchise, Joint venture. All users, partners (IPP/IBP), and clients operate as independent entities."
                }
            ]
        },
        {
