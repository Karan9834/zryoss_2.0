export const blogsData = [
  ...
  {
    id: "what-is-IBP",
    title: "What is IBP (Independent Business Partner)? Build 3 Businesses & an IPP Network Under One System",
    ...
    content: `
      ...
      <h3 style="font-weight: bold; margin-top: 25px; margin-bottom: 15px;">The Power of IBP</h3>
      <p style="margin-bottom: 15px;">The Independent Business Partner (IBP) allows a single partner to:</p>
      <ul style="margin-bottom: 20px;">
  ...
  },
  {
    ...
    title: "Top Business Domains You Can Start Through IPP & IBP Models in 2026",
  ...
  },
  {
    ...
    excerpt: "The era of solo founders doing everything is fading. Solo models often fail due to burnout, limited skills, and execution gaps. Rise of partner-driven models offer shared expertise, faster execution, and sustainable growth. IPP empowers focused entrepreneurs while IBP creates ecosystem leaders.",
    content: `
      ...
      <p style="margin-bottom: 15px;">IPP and IBP represent the new era of business ownership—where you lead the market while we manage the machine.</p>
    `
  },
  {
