  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: `An IBP is a larger-scale business partner who can handle multiple verticals and manage their own IPPs under them.
        <br/><br/>
        Zryoss provides:
        <ul class="list-disc pl-5 mt-2 space-y-2 text-gray-400">
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "Each IPP/IBP or client gets a Dedicated Account Manager. They handle: Communication & reporting, Escalations, Progress updates, Coordination between teams. No confusion, no multi-channel follow-ups."
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "Yes. IPP can select their preferred domain like IT, HR, Marketing, etc. IBPs can select multiple verticals and manage multiple IPPs."
      },
      {
