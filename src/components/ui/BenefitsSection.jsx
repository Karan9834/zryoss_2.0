...
const App = () => {
  ...
  const checklistItems = [
    ...
    {
      title: "Transparent commercial tracking",
              ...
              <div className="grid gap-2">
                {checklistItems.map((item, i) => (
                  <div
                    ...
                    className={`flex items-center gap-3 p-3 rounded-xl border transition-all duration-300 cursor-pointer group ${activeTab === i
                      ? "bg-white/10 border-orange-500/50 translate-x-2"
                      : "bg-white/5 border-white/5 hover:bg-white/8 hover:border-white/20"
                      }`}
                  >
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 transition-all duration-300 ${activeTab === i ? "bg-orange-600 scale-110" : "bg-orange-600/20"
                      }`}>
                      <CheckCircle2
                    ...
                    <span className={`text-base transition-colors duration-300 ${activeTab === i ? "text-white font-medium" : "text-neutral-200"
                      }`}>
                      {item.title}
                    </span>
                  </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex justify-between items-center text-[10px] text-neutral-400 font-mono pt-3 border-t border-white/10">
                          ...
                          <div className="text-right">
                            <span className="text-[9px] uppercase opacity-50 mb-0.5">Commercials</span>
                            <div className="text-orange-500 font-bold text-xs">High Growth Potential</div>
                          </div>
                        </div>
                      </div>
                    </div>
