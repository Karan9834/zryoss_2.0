  ...
  const navData = [
...

    {
      ...
      columns: [
        ...
        {
          heading: "IBP – Independent Business Partner",
          links: [
            { title: "IBP Overview", to: "/partnership/IBP", icon: <LayoutGrid className="w-4 h-4" /> },
            { title: "Multi-Vertical Business Model (3 Verticals)", to: "/partnership/IBP/business-model", icon: <FileText className="w-4 h-4" /> },
      ...
      columns: [
        {
          ...
          links: [
            ...
            { title: "CLink Group", to: "/clink-group", icon: <Users className="w-4 h-4" /> },
