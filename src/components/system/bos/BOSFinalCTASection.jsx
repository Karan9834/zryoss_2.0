...
export default function BOSFinalCTASection() {
  return (
    <section className="relative bg-[#0B0F14] py-16 md:py-24 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="rounded-[44px] border border-orange-500/20 bg-gradient-to-b from-orange-500/12 to-transparent p-10 md:p-14 shadow-[0_0_55px_rgba(249,115,22,0.14)] overflow-hidden relative text-center"
        >
          ...
          <h2 className="relative text-3xl md:text-5xl font-extrabold text-white leading-tight">
            ...
            <span className="text-orange-500">System</span> — Not Just Effort
          </h2>

          <p className="relative mt-5 text-white/70 text-base md:text-lg max-w-3xl mx-auto leading-relaxed">
            Effort creates momentum. Systems create sustainability.
            Zryoss provides the operating foundation that turns ideas into structured
            businesses and businesses into scalable brands.
          </p>
